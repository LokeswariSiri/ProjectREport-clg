...
def createnotepad():
    filename = filedialog.askopenfilename(title='Open Notepad')
    f=str(filename)
    lis=f.split("/")
    print(lis)
    #from tkinter import *
...
def open_img():
    ...
    panel.image = img
    panel.place(x=550,y=200)

def video_file():
    os.system('python video_detectionfn.py')
        

#btn = Button(root, text='open image',font = ("Helvetica", 15),  fg = "blue", bg = "orange", command=open_img).pack(padx=5,pady=3)
btn = Button(root, text='open image',font = ("Helvetica", 15),  fg = "blue", bg = "orange", command=open_img).place(x=525,y=100)
btn = Button(root, text='Select_Notepad_RecognizeText',font = ("Helvetica", 15),  fg = "blue2", bg = "greenyellow", command=main_method).place(x=715,y=100)
btn = Button(root, text='Video_file',font = ("Helvetica", 15),  fg = "blue2", bg = "VioletRed1", command=video_file).place(x=1100,y=100)
